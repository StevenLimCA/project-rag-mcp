...
SEARCH_TOP_K = 5
SEARCH_GLOBAL_OVERFETCH_MIN = env_int("SEARCH_GLOBAL_OVERFETCH_MIN", 1000)
SEARCH_GLOBAL_OVERFETCH_MULTIPLIER = env_int("SEARCH_GLOBAL_OVERFETCH_MULTIPLIER", 200)

# Auto-sync settings
AUTO_SYNC_ON_QUERY = _env_bool("AUTO_SYNC_ON_QUERY", "true")
AUTO_SYNC_MIN_INTERVAL_SECONDS = env_int("AUTO_SYNC_MIN_INTERVAL_SECONDS", 300)
AUTO_SYNC_MAX_DOCUMENTS_ON_QUERY = env_int("AUTO_SYNC_MAX_DOCUMENTS_ON_QUERY", 250)
